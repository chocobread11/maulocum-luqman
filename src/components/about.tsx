...
export const AboutMauLocum = () => {
            ...
            <div className="container px-8">
                <div className="text-center min-h-[72px]">
                    ...
                    <p className="mt-6 font-medium text-muted-foreground">
                        Learn more about the purpose, users, and principles behind the MauLocum platform.
                    </p>
                </div>
    ...
    <div className="mb-10 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
            This platform was designed and developed as part of an IIUM Final Year Project.
        </p>
    </div>
    ...
    <Card className="w-full max-w-sm">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
            ...
            Final Year IT student at IIUM, responsible for full-stack development,
            including frontend interfaces, backend services, database design,
            and system integration for the MauLocum platform.
        </p>
    ...
    <Card className="w-full max-w-sm">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
            ...
            Final Year IT student at IIUM, responsible for frontend architecture, 
            UI consistency, and user experience design for the MauLocum platform.
            </p>
