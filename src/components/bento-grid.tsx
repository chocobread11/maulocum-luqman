...
const BentoGrid = ({
	...
	return (
		<div
			className={cn(
				"grid w-full auto-rows-[22rem] grid-cols-3 gap-2 py-10",
				className,
			)}
		>
			{children}
...
const BentoCard = ({
	...
	<div
		key={name}
		className={cn(
			"group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl text-primary-foreground",
			// light styles
