		...
		return (
			<Card className="w-full">
				<CardHeader className="px-4 sm:px-6 py-4 sm:py-6">
					<CardTitle className="text-lg sm:text-xl">No Linked Facility</CardTitle>
		...
		<Card className="w-full">
			<CardHeader className="flex flex-row items-center gap-3 sm:gap-4 px-4 sm:px-6 py-4 sm:py-6">
				...
				<div className="flex-1 min-w-0">
					<CardTitle className="text-base sm:text-xl truncate">{facility.name}</CardTitle>
			...
			<CardContent className="space-y-2 sm:space-y-3 px-4 sm:px-6 py-2 sm:py-4">
				...
				{facility.email && (
					<div className="flex items-center gap-2">
						...
						<span className="text-xs sm:text-sm break-all">{facility.email}</span>
					</div>
				)}
			</CardContent>
			<CardFooter className="flex flex-col sm:flex-row sm:justify-between gap-2 px-4 sm:px-6 py-4 sm:py-6">
				...
				<Button size="sm" asChild className="w-full sm:w-auto text-xs sm:text-sm h-8 sm:h-9">
