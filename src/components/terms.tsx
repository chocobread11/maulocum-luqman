				...
				<CardContent className="space-y-6 text-sm leading-relaxed">
					<section>
						<p>
							...
							and use of the MauLocum platform ("the Platform"). By
							accessing or using this Platform, you agree to be bound by
							these Terms. If you do not agree, please discontinue use of
							the Platform.
						</p>
					</section>
					...
					<section>
						...
						<p>
							MauLocum is a web-based locum hiring platform designed to
							connect healthcare facilities with verified locum
							professionals in Malaysia. The Platform facilitates job
							posting, browsing, applications, and communication but does
							not act as an employer or recruitment agency.
						</p>
					</section>
					...
					<section>
						...
						<ul className="list-disc pl-5 space-y-1">
							...
							<li>Healthcare facilities must provide accurate business information</li>
					...
					<section>
						...
						<p>
							Users are required to register an account to access full
							platform features. You agree to provide accurate and
							complete information and to update it when necessary.
							MauLocum reserves the right to suspend or terminate accounts
					...
					<section>
						...
						<p>
							Healthcare professionals may be required to submit
							professional documents such as APC or licenses for
							verification. MauLocum verifies credentials for platform
							access but does not guarantee employment or job placement.
						</p>
					</section>
					...
					<section>
						...
						<p>
							Healthcare facilities are responsible for the accuracy of
							job postings, including pay rates, schedules, and job
							requirements. MauLocum is not responsible for disputes
							arising from job agreements between users.
						</p>
					</section>
					...
					<section>
						...
						<p>
							...
							experiences. Reviews must be truthful, respectful, and free
							from offensive content. MauLocum reserves the right to
							moderate or remove content that violates these Terms.
						</p>
					</section>
					...
					<section>
						...
						<p>
							All personal data is handled in accordance with the
							MauLocum Privacy Policy and Malaysia’s Personal Data
					...
					<section>
						...
						<p>
							MauLocum shall not be liable for any indirect, incidental,
							or consequential damages arising from the use of the
							Platform. The Platform is provided on an "as-is" basis.
						</p>
					</section>
					...
					<section>
						...
						<p>
							MauLocum reserves the right to suspend or terminate user
					...
					<section>
						...
						<p>
							...
							the Platform after changes indicates acceptance of the
							revised Terms.
						</p>
					</section>
					...
					<section>
                        ...
                        <p className="mt-2">
                            All agreements, payments, and professional engagements are
                            entered into directly between users. MauLocum shall not be
                            responsible for disputes, losses, or liabilities arising from such
                            arrangements.
                        </p>
                    </section>
